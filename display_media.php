...
<div class="col mx-0"> 
    <div class="card text-center" style="width: 18rem;">
        <a href="media.php?id=<?php echo $mediaid;?>" target="_blank">
            <?php if(strpos($type, "image") !== False) {?><img class="card-img-top" style="height:250px" src="<?php echo $filenpath; ?>" alt="Card image cap">
            <?php } else { ?>
                <img class="card-img-top" style="height:250px" src="site/thumbnail.png" alt="Thumbnail">
            <?php }?>
        </a>
        <div class="card-body">
